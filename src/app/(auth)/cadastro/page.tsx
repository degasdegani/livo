...
export default function CadastroPage() {
  ...
  // cookie de curta duração, para o caso do link ter passado por outra página
  // do site antes de chegar aqui.
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm mb-8" style={{ color: "#52525B" }}>
        Teste grátis o plano PRO. Sem cartão de crédito.
      </p>
      ...
      >
        ...
        <p className="text-xs" style={{ color: "#52525B", lineHeight: 1.5 }}>
          CPF, endereço e demais dados da barbearia são pedidos depois, direto
          no painel — sem travar o começo agora.
        </p>
        ...
        >
          <input
            ...
            style={{ accentColor: "var(--livo-cream)" }}
          />
          <span>
            Li e aceito os{" "}
            <a
