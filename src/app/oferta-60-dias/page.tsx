...
export const metadata: Metadata = {
  title: "60 Dias Grátis | LIVO Barber",
  description:
    "Você recebeu acesso exclusivo para testar o LIVO Barber gratuitamente por 60 dias.",
  openGraph: {
    title: "60 Dias Grátis | LIVO Barber",
    description:
      "Você recebeu acesso exclusivo para testar o LIVO Barber gratuitamente por 60 dias.",
...
export default function Oferta60DiasPage() {
  return (
    <main
      style={{
        minHeight: "100vh",
    ...
    >
      ...
      >
        ...
        >
          ...
          Barber sem custo durante 60 dias.
        </p>
